...
int sha512_256_init(sha512_256_context *ctx)
{
	...
	ctx->sha512_state[0] = (uint64_t)(0x22312194FC2BF72C);
	ctx->sha512_state[1] = (uint64_t)(0x9F555FA3C84C64C2);
	ctx->sha512_state[2] = (uint64_t)(0x2393B86B6F53B151);
	ctx->sha512_state[3] = (uint64_t)(0x963877195940EABD);
	ctx->sha512_state[4] = (uint64_t)(0x96283EE2A88EFFE3);
	ctx->sha512_state[5] = (uint64_t)(0xBE5E1E2553863992);
	ctx->sha512_state[6] = (uint64_t)(0x2B0199FC2C85B8AA);
	ctx->sha512_state[7] = (uint64_t)(0x0EB72DDC81C52CA2);
