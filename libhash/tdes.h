...
#if defined(WITH_BC_TDEA) || defined(WITH_HASH_MDC2)
...
typedef struct {
    des_direction dir;
    uint64_t sk[16]; /* encryption/decryption subkeys */
} des_context;
...
/* DES key schedule */
int des_set_key(des_context *ctx, const uint8_t k[8], des_direction dir);

/* DES encryption/decryption */
int des(const des_context *ctx, const uint8_t input[8], uint8_t output[8]);

/* TDES key schedules */
int des3_set_keys(des3_context *ctx, const uint8_t k1[8], const uint8_t k2[8], const uint8_t k3[8], des_direction dir);

/* TDES encryption/decryption */
int des3(const des3_context *ctx, const uint8_t input[8], uint8_t output[8]);
