...
#define SHA2CORE(a, b, c, d, e, f, g, h, w, k, sha_uint64_type, sha_type) do {\
	sha_uint64_type t1, t2;\
...
/* SHA-224 and SHA-256 */
#define SHR_SHA256(x, n)       (((uint32_t)(x)) >> (n))
#define ROTR_SHA256(x, n)      ((((uint32_t)(x)) >> (n)) | (((uint32_t)(x)) << (32-(n))))
...
#define SHA2CORE_SHA256(a, b, c, d, e, f, g, h, w, k) \
	SHA2CORE(a, b, c, d, e, f, g, h, w, k, uint32_t, SHA256)
...
#define SHA2CORE_SHA512(a, b, c, d, e, f, g, h, w, k) \
	SHA2CORE(a, b, c, d, e, f, g, h, w, k, uint64_t, SHA512)
