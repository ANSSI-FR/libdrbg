...
int sha512_init(sha512_context *ctx)
{
	...
	ctx->sha512_state[0] = (uint64_t)(0x6A09E667F3BCC908);
	ctx->sha512_state[1] = (uint64_t)(0xBB67AE8584CAA73B);
	ctx->sha512_state[2] = (uint64_t)(0x3C6EF372FE94F82B);
	ctx->sha512_state[3] = (uint64_t)(0xA54FF53A5F1D36F1);
	ctx->sha512_state[4] = (uint64_t)(0x510E527FADE682D1);
	ctx->sha512_state[5] = (uint64_t)(0x9B05688C2B3E6C1F);
	ctx->sha512_state[6] = (uint64_t)(0x1F83D9ABFB41BD6B);
	ctx->sha512_state[7] = (uint64_t)(0x5BE0CD19137E2179);
