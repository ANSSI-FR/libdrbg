...
static int sha384_process(sha384_context *ctx,
			   const uint8_t data[SHA384_BLOCK_SIZE])
{
...
int sha384_init(sha384_context *ctx)
{
	...
	ctx->sha384_state[0] = (uint64_t)(0xCBBB9D5DC1059ED8);
	ctx->sha384_state[1] = (uint64_t)(0x629A292A367CD507);
	ctx->sha384_state[2] = (uint64_t)(0x9159015A3070DD17);
	ctx->sha384_state[3] = (uint64_t)(0x152FECD8F70E5939);
	ctx->sha384_state[4] = (uint64_t)(0x67332667FFC00B31);
	ctx->sha384_state[5] = (uint64_t)(0x8EB44A8768581511);
	ctx->sha384_state[6] = (uint64_t)(0xDB0C2E0D64F98FA7);
	ctx->sha384_state[7] = (uint64_t)(0x47B5481DBEFA4FA4);
...
int sha384_final(sha384_context *ctx, uint8_t output[SHA384_DIGEST_SIZE])
{
	...
	uint8_t last_padded_block[2 * SHA384_BLOCK_SIZE];
	int ret;
	...
	if (block_present > (SHA384_BLOCK_SIZE - 1 - (2 * sizeof(uint64_t)))) {
		/* We need an additional block */
		PUT_MUL8_UINT128_BE(ctx->sha384_total[0], ctx->sha384_total[1],
				    last_padded_block,
				    2 * (SHA384_BLOCK_SIZE - sizeof(uint64_t)));
		...
		PUT_MUL8_UINT128_BE(ctx->sha384_total[0], ctx->sha384_total[1],
				    last_padded_block,
				    SHA384_BLOCK_SIZE - (2 * sizeof(uint64_t)));
		ret = sha384_process(ctx, last_padded_block); EG(ret, err);
	}
		      ...
		      uint8_t output[SHA384_DIGEST_SIZE])
{
	...
	while (inputs[pos] != NULL) {
		const uint8_t *buf = inputs[pos];
		uint32_t buflen = ilens[pos];
